...
from my_option_bar import option_menu
...
def streamlit_config():
    ...
    # page configuration
    st.set_page_config(page_title='YouTube Data Harvesting and Warehousing, UCSSQc_gx48JHh8CAIFnj0fg , AIzaSyB7TpLKnDYrTZAm9JEA2kI1UAt1yQfPrgg ',
...
class mongodb:
    ...
    def data_storage(channel_name, database, data):
        anuprasad = pymongo.MongoClient(
            "mongodb+srv://anuprasad4444:1234567890@cluster0.nw9dkpu.mongodb.net/")
        db = anuprasad[database]
        col = db[channel_name]
        col.insert_one(data)
...
with st.sidebar:
    option = option_menu(menu_title='', options=['Data Retrive from YouTube API', 'Store data to MongoDB',
                         ...
                         icons=['1.', '2.', '3.', '4.', '5.', '6.'],
                         menu_icon="cast", default_index=0) # Add menu_icon and default_index for proper functionality
